...
$(function(){
    ...
    var chatbot = {
        ...
        greeting: "Hi there! Hope you are having a great day.",
        questions: {
            ask: 'So what would you like to order?',
            //you can add:
            answers:[
                {
                    value: 'pizza',
                    ask:'Pepperoni or Cheese?'
                }
            ]
        },
        answers: [],
        ...
        //#### setTimeout : connecting yo, please wait #####
        wait: function(msg){
          msg = 'Connecting you to someone, please wait.';
          $('#conversation').append('<li class="list-group-item text-left">' + msg + '</li>');
        },
        //#### METHODS ####
        start: function() {
            this.ask(this.greeting);
            this.ask(this.questions.ask);
            this.wait(msg);
        },
